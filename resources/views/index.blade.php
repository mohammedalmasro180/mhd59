...
<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
  ...
  <section class="w3l-main-slider" id="home">
    <div class="companie s20-content">
          ...
          <div class="row features-hny-inner-gd">
            <div class="col-md-2 col-2 featured_grid_left">
              <div class="icon-hnynumber">
                <span class="hnynumber">{{ $post->id }}</span>
              </div>
            </div>
            <div class="col-md-10 col-10 featured_grid_right_info">
              <h4><a class="link-hny" href="/about{{$post->id}}">{{ $post->address }}</a></h4>
              <p>
      ...
      <div class="cwp4-two row align-items-center">
        ...
        <div class="cwp4-text col-lg-6 mt-lg-0 mt-5">
          ...
          <ul class="cont-4 mt-lg-6 mt-md-5 mt-4">
            ...
            <img src="assets/uploads/one/{{$block->img3 }}"  width="55px" height="55px" alt="...">
            ...
            <li class="subhny-gd mt-sm-0 mt-4">
            <img src="assets/uploads/one/{{$block->img2 }}"  width="55px" height="55px" alt="...">
              <h4><a class="link-hny" href="#url">
              {{$block->address3}}      </a></h4>
              <p>
              {{$block->text3}}      
      ...
      @foreach ($products as $product)
        ...
        <div class="item">
          <div class="news-img position-relative">
            <a href="#"><img src="assets/uploads/one/{{$product->img }}" class="img-fluid" width="640px" height="427px" alt="news image"></a>
